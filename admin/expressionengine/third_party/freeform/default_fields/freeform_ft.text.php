 ...
 * @package 	Solspace:Freeform
 * @author		Solspace DevTeam
 * @filesource 	./system/expressionengine/third_party/freeform/freeform_ft.text.php
 */
...
class Text_freeform_ft extends Freeform_base_ft
{
	...
	{
		//max field length
		$field_length 	= $this->EE->input->get_post('field_length');
		...
		$field_content_type = $this->EE->input->get_post('field_content_type');
