 ...
 * @package 	Solspace:Freeform
 * @author		Solspace DevTeam
 * @filesource 	./system/expressionengine/third_party/freeform/libraries/Freeform_forms.php
 */
...
class Freeform_forms extends Addon_builder_freeform
{
	...
	public function update_form_fields ($form_id, $field_ids)
	{
		...
		$p_table_name			= (substr($table_name, 0, strlen(ee()->db->dbprefix)) !== ee()->db->dbprefix) ?
		...
		$current_fields 		= ee()->freeform_entry_model->id($form_id)->list_table_fields(FALSE);
