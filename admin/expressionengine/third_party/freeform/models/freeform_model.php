 ...
 */
 ...
 /**
 * Freeform - Freeform Base Model
 *
 * @package 	Solspace:Freeform
 * @author		Solspace DevTeam
 * @filesource 	./system/expressionengine/third_party/freeform/models/freeform_model.php
 */
...
class Freeform_Model extends CI_Model
{
	...
	public function get ($where = array(), $cleanup = TRUE, $all = TRUE)
	{
		...
		$cache = $this->cacher(array(func_get_args(), $this->{$stash}), __FUNCTION__);
