	...
	<div id="main" class="clearfix">
		...
		<div id="content">
			...
			<section>
				...
				<?php echo form_open('admin/sites/new_site', array('id' => 'site-form', 'class' => 'admin-form')); ?>
				<p>
				...
				<p>
					...
					<input type="text" name="postcode" id="postcode" value="<?php echo set_value('postcode'); ?>">
				</p>
				<p>
					<label for="deposit_percentage">Deposit %</label>
					<input type="text" name="deposit_percentage" id="deposit_percentage" value="<?php echo set_value('deposit_percentage'); ?>">
				</p>
				<p>
