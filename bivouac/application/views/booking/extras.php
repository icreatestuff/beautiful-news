<?php 
$data['title'] = "Add some extras to your booking!";
	...
	<div id="main" role="main">
		...
		<section>
			...
			<div class="content" id="extras">
				...
				<?php echo form_open('booking/extras/' . $booking_id, array('id' => 'extras-booking-form', 'class' => 'booking-form')); ?>
					...
					<input type="submit" id="submit" name="submit" value="Proceed to add booking contact" />
				</form>
			</div>
		</section>
	</div>	
